...
/**
 * LMLPHP Framework
 * Copyright (c) 2016 http://lmlphp.com All rights reserved.
...
class Lmlphp {
	...
	private static function init(){
		...
		error_reporting(0);
		set_error_handler(array('\lmlphp\LmlErrHandle', 'onErr'));
		set_exception_handler(array('\lmlphp\LmlErrHandle', 'onException'));
		register_shutdown_function(array('\lmlphp\LmlErrHandle', 'onFatalErr'));
		spl_autoload_register(array('\lmlphp\LmlUtils', 'autoload'));
